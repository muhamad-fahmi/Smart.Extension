                ...
                <div class="col-xxl-3 cåol-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0 mt-4">
                    <div class="widget-content widget-content-area blog-create-section">
                        <div class="row">
                            ...
                            <img src="{{ asset('assets/devices/images/'.$device_category->image) }}" alt="" class="w-100 rounded-4 mb-4">
                            ...
                            <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                                <button type="submit" class="btn btn-success w-100">Update Device Category</button>
                            </div>
